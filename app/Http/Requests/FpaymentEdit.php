...
class FpaymentEdit extends CommonRules
{
    /**
    ...
    {
        return parent::rules() + [
            'number' => 'bail|required|unique:fpayments,number,'.$this->id,
            'contract_number' => 'bail|required|integer|min:0|unique:fpayments,contract_number,'.$this->id,
