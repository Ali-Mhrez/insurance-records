...
@section('title')الدفعات النقدية | الحوالات النهائية
@endsection
...
@section('card-title')
إضافة دفعة نقدية | حوالة نهائية جديدة
@endsection

@section('form')

    <form action="{{ route('fpayment.store') }}">
        @csrf()
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-4" id="bankCreate">
