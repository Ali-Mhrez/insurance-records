...
@section('title')
    الدفعات النقدية | الحوالات النهائية
@endsection
...
@section('card-title')
    تعديل دفعة نقدية | حوالة نهائية
@endsection

@section('form')
    <form action="{{ route('fpayment.update', ['id' => $payment->id]) }}">
        @csrf()
        <div class="row">
        ...
        <div class="row">
            <div class="form-group col-md-4">
                ...
                <input type="number" step="0.01" class="form-control @error('value') is-invalid @enderror" id="value" name="value"
        ...
        <div class="row">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control @error('contract_number') is-invalid @enderror"
                    ...
                    value="{{ old('contract_number', $payment->contract_number) }}">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="date" class="form-control @error('contract_date') is-invalid @enderror"
                    id="contract_date" name="contract_date" placeholder="" value="{{ old('contract_date', $payment->contract_date) }}">
                @error('contract_date')
                    <li class=" alert alert-danger">{{ $message }}</li>
                @enderror
            </div>
