@extends("templates.CUoperrations")
    ...
    @section('card-title')
    إضافة كفالة بدائية جديدة
    @endsection

    @section('form')
     <form role="form" action="{{ route('guarantee.store') }}" style="direction: rtl">
          ...
          <div class="row">
              ...
              <div class="form-group col-4" id="first">
                  ...
                  <input type="number" step="0.01" class="form-control @error('equ_val_sy') is-invalid @enderror" id="equ_val_sy" name="equ_val_sy" placeholder="" value="{{ old('equ_val_sy') }}">
                  @error('equ_val_sy')
                      <li class=" alert alert-danger">{{ $message }}</li>
                  @enderror
              </div>
